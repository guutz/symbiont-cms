 ...
 */
export async function getBotUserId(notion: Client): Promise<string | null> {
 ...
 */
export function wasLastEditedByBot(page: PageObjectResponse, botUserId: string | null): boolean {
	if (!botUserId) return false;
	return (page.last_edited_by as { id?: string } | undefined)?.id === botUserId;
}
