...
export declare const LIMITS: {
    readonly PAYLOAD_BLOCKS: 1000;
    readonly RICH_TEXT_ARRAYS: 100;
    readonly RICH_TEXT: {
        readonly TEXT_CONTENT: 2000;
        readonly LINK_URL: 1000;
        readonly EQUATION_EXPRESSION: 1000;
    };
};
 ...
 */
export type BlockTransformerFn = (block: any, fetchChildren: (blockId: string) => Promise<any[]>) => Promise<string | false> | string | false;
/**
