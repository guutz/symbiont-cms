...
import { diffBlocks, fingerprintBlock, blocksAreEquivalent, normalizeBlockForDiff, } from './blocks-diff.js';
import { sanitizeContentForUpdate } from './client.js';
// ── Fixtures ─────────────────────────────────────────────────────────────────
function makeParagraph(content, id) {
    return {
        ...(id ? { id } : {}),
        type: 'paragraph',
        paragraph: {
...
function makeHeading2(content, id) {
    return {
        ...(id ? { id } : {}),
        type: 'heading_2',
        heading_2: {
...
function makeEquation(expression, id) {
    return {
        ...(id ? { id } : {}),
        type: 'equation',
        equation: { expression },
...
describe('diffBlocks — desired block has children', () => {
    function makeQuoteWithChildren(children, id) {
        return {
            ...(id ? { id } : {}),
            type: 'quote',
            quote: {
    ...
    function makeCalloutWithChildren(children, id) {
        return {
            ...(id ? { id } : {}),
            type: 'callout',
            callout: {
